...
Click the 'New' button to create a new environment variable. Type in `R_LIBS_USER` for the variable name and `G:/Management/r_package_library` for the variable value. Press OK.

![Step 2](images/node_setup_2.PNG)
...
![Step 3](images/node_setup_3.PNG)
...
![Step 4](images/node_setup_4.PNG)

It should return the path you just set above (`'G:/Management/r_package_library'`) . If it does not for some reason, please contact [Bryan Blanc](mailto:bblanc@nelsonnygaard.com) to make him aware of the issue, and he will work with IT to help you resolve the issue.
