...
#Using an API Key set up for NN R training -- please use your own API key in place of this one
...
```{r google-map-am-trip, fig.height=8, fig.width=12, fig.cap='Example AM Commute Routes'}
dir_results_am = google_directions(origin = '45.63039565205174, -122.58032084515692',
                  ...
                  mode = 'driving',
                  departure_time = as.POSIXct('2021-06-01 07:30:00'),
                  alternatives = TRUE)
...
```{r google-map-pm-trip, fig.height=8, fig.width=12, fig.cap='Example AM Commute Routes'}
dir_results = google_directions(destination = '45.63039565205174, -122.58032084515692',
                  origin = '45.51969205229432, -122.6822162060739',
                  mode = 'driving',
                  departure_time = as.POSIXct('2021-06-01 17:15:00'),
                  alternatives = TRUE)
...
ggplot(sub_tt_index,aes(x=year,y=index,color=NAME,group=NAME))+
  geom_line()+ylab('Travel Time Index')+xlab('Year')+
