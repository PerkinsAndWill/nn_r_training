...
*This content was presented to Nelson\\Nygaard Staff at a Lunch and Learn webinar on Friday, September 17th, 2020, and is [available as a recording here](LINK TO BE SHARED) and embedded below (TODO)*
...
*__Acknowledgment:__ This portion of this module heavily draws upon, including direct copy-paste of markdown content, the vignettes developed for the `tigris` package, available on the package [documentation website](TODO). *
...
#Binding sf objects is still a little wonky
...
*This content was presented to Nelson\\Nygaard Staff at a Lunch and Learn webinar on Friday, September 17th, 2020, and is [available as a recording here](LINK TO BE SHARED) and embedded at the top of the page. (TODO)*